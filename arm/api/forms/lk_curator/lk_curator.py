...
from arm.tools.DC import well, DC, toWell
...
class lk_curator(Page):
    ...
    def __init__(self, request):
        ...
        self.jsCssUrl = [f'/api/jsv?forms/lk_curator/lk_curator.js']
        self.leftWidth = 105
    ...
    def getData(self, dcUK):
        ...
        # CH GROUP
            ...
            data = well('sessionsGr_GrId_band', dcUK.groupdId) or []
            if dcUK.status != '1':
