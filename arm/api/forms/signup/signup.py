...
@author: aon24
'''
from arm.api.forms.formTools import style, _div, _form, _input, _teg, _btnD, _field, _a
from arm.api.forms.classPage import Page
from arm.tools.DC import config, well
                  ...
                  children=[
                    ...
                    _div(
                      **style(display='flex', justifyContent='space-evenly', alignItems='center'),
                      children=[
                        _field('phone', 'phone', noBtn=1, autoFocus=True, **style(width=210, fontSize=20)),
                    ...
                    **style(border='0 solid #fff', borderTopWidth=2, width='100%', textAlign='left'),
                    method='post', action='/api/signup/', children=[
                        ...
                        _div(children=[
                            _div('Логин:'),
                            _input(
                                **style(fontSize=35, width='calc(100% - 10px)', paddingLeft=5),
                                type="text",
                                name="username",
                                required=True,
                        ...
                        _div(**style(marginTop=20), children=[
                            _div('Пароль не менее 5 символов'),
                            _input(
                                **style(fontSize=35, width='calc(100% - 10px)', paddingLeft=5),
                                type="password",
                                name="password1",
                        ...
                        _div(children=[
                            ...
                            _input(
                                **style(font='normal 30px/2 Courier', width='calc(100% - 10px)', paddingLeft=5),
                                type="text",
                                name="email",
                                required=True,
                        ...
                        _div(**style(textAlign='center', padding='15px 0', border='0 solid #fff', borderBottomWidth=2),
                             children=[
                                _btnD('Отправить', 'submit', 'signup',
                        ...
                        _div(**style(lineHeight='12px', textAlign='center', padding=10, border='0 solid #fff', borderBottomWidth=2),
                             children=[_a('Политика в отношении обработки персональных данных',
                        ...
                        _div(**style(lineHeight='12px', textAlign='center', padding=10, border='0 solid #fff', borderBottomWidth=2),
                             children=[_a('Согласие на обработку персональных данных',
                                          **style(fontSize=20), target='_blank',
                        ...
                        _div(**style(lineHeight='12px', textAlign='center', padding=10),
                             children=[_a('Пользовательское соглашение',
                                          **style(fontSize=20), target='_blank',
