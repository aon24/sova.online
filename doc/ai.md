💎 **Эту форму полностью сделал DeepSeek**

**📌 комментарий**

Я спросил дипсика (DeepSeek), как можно обойти
ограичения 128K токенов, если я хочу с ним работать
в над проектом в течение недель или месяцев.
Дипсик попросил общее описание, чтобы создать файл
файл проекта, в котором будут накапливаться задания
и решения. Я описал общий принцип: на питоне создается
форма в виде xml-словаря, клиент парсит xml в html
и рендерит страницу.
Я отправил ему базовый класс Page, от которого наследуются 
все формы, в качестве примера дал
простенькую форму и поросил сделать форму для отображение md-файлов

Ниже история создания этой формы
